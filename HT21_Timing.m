...
Directory = 'MOTChallengeEvalKit-master/data/HT21/train';
Files = dir('MOTChallengeEvalKit-master/data/HT21/train');
...
CT_Settings.eps = 18; 
CT_Settings.TrackletMerge_OverlapRatio = 0; % "IOU Thresh" above
...
IOU_Settings.t_min = 2;

% SORT
SORT_Settings.max_age=30;
...
% Get filenames from folder that we will analyze
Directory = 'MOTChallengeEvalKit-master/data/HT21/test';
Files = dir('MOTChallengeEvalKit-master/data/HT21/test');
Files = Files(3:length(Files)) % Get rid of trash entries - Windows version
...
writematrix(Time_CTv0,'HT21_CTv0_Timing')
writematrix(Time_IOU,'HT21_IOU_Timing')
writematrix(Time_SORT,'HT21_SORT_Timing')
writematrix(Time_OCSORT,'HT21_OCSORT_Timing')
